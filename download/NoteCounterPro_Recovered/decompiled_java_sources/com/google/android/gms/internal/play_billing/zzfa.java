...
final class zzfa extends zzex implements zzew {
    ...
    public final /* bridge */ /* synthetic */ ScheduledFuture schedule(Runnable runnable, long j2, TimeUnit timeUnit) {
        ...
        return new zzey(zzr, scheduledExecutorService.schedule(zzr, j2, timeUnit));
    }
    ...
    public final /* bridge */ /* synthetic */ ScheduledFuture scheduleAtFixedRate(Runnable runnable, long j2, long j5, TimeUnit timeUnit) {
        ...
        return new zzey(zzezVar, this.zza.scheduleAtFixedRate(zzezVar, j2, j5, timeUnit));
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public final /* bridge */ /* synthetic */ ScheduledFuture scheduleWithFixedDelay(Runnable runnable, long j2, long j5, TimeUnit timeUnit) {
        zzez zzezVar = new zzez(runnable);
        return new zzey(zzezVar, this.zza.scheduleWithFixedDelay(zzezVar, j2, j5, timeUnit));
    }

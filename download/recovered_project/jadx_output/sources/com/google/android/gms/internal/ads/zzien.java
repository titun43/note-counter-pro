...
final class zzien {
    ...
    public static /* synthetic */ void zzb(byte b2, byte b5, char[] cArr, int i5) {
        if (b2 < -62 || zze(b5)) {
    ...
    public static /* synthetic */ void zzc(byte b2, byte b5, byte b6, char[] cArr, int i5) {
        if (!zze(b5)) {
            if (b2 == -32) {
                if (b5 >= -96) {
                    b2 = -32;
    ...
    public static /* synthetic */ void zzd(byte b2, byte b5, byte b6, byte b7, char[] cArr, int i5) {
        if (!zze(b5)) {

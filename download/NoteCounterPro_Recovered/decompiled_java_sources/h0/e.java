...
public final class e extends InputConnectionWrapper {
    ...
    public final /* synthetic */ com.getcapacitor.plugin.c f1708a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(InputConnection inputConnection, com.getcapacitor.plugin.c cVar) {
    ...
    public final boolean performPrivateCommand(String str, Bundle bundle) {
        ...
        com.getcapacitor.plugin.c cVar = this.f1708a;
        boolean z4 = false;
        z4 = false;
        z4 = false;
        z4 = false;
            ...
            try {
                ...
                try {
                    ...
                    if (uri != null && clipDescription != null) {
                        z4 = cVar.e(new j(uri, clipDescription, uri2), i5, bundle2);
                    }
                    if (resultReceiver != null) {
                        resultReceiver.send(z4 ? 1 : 0, null);
                    }
                } catch (Throwable th) {
                    th = th;
                    if (resultReceiver != null) {

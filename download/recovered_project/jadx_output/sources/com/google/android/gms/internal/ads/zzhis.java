...
public final class zzhis {
    ...
    public static BigInteger zzc(EllipticCurve ellipticCurve) {
    ...
    public static ECPoint zzd(BigInteger bigInteger, ECParameterSpec eCParameterSpec) {
        ECPoint eCPoint;
        ...
        zzhir zze2 = zze(ECPoint.POINT_INFINITY, zzc2);
        zzhir zze3 = zze(generator, zzc2);
        for (int bitLength = bigInteger.bitLength(); bitLength >= 0; bitLength--) {
            if (bigInteger.testBit(bitLength)) {
                zze2 = zzg(zze2, zze3, a5, zzc2);
                zze3 = zzf(zze3, a5, zzc2);
            } else {
                zze3 = zzg(zze2, zze3, a5, zzc2);
                zze2 = zzf(zze2, a5, zzc2);
            }
        }
        if (zze2.zza()) {
    ...
    public static zzhir zze(ECPoint eCPoint, BigInteger bigInteger) {
        ...
        BigInteger mod = new BigInteger(1, zzhle.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger mod2 = mod.multiply(mod).mod(bigInteger);
        return new zzhir(eCPoint.getAffineX().multiply(mod2).mod(bigInteger), eCPoint.getAffineY().multiply(mod2.multiply(mod).mod(bigInteger)).mod(bigInteger), mod);
    }
    ...
    public static zzhir zzf(zzhir zzhirVar, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        return new zzhir(mod5, mod6, add3.multiply(add3).mod(bigInteger2).subtract(mod2).subtract(mod4).mod(bigInteger2));
    }
    ...
    public static zzhir zzg(zzhir zzhirVar, zzhir zzhirVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger mod3 = zzhirVar.zza.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzhirVar2.zza.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzhirVar.zzb.multiply(bigInteger4).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzhirVar2.zzb.multiply(bigInteger3).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            return !mod5.equals(mod6) ? zzhir.zzd : zzf(zzhirVar, bigInteger, bigInteger2);
        }
        ...
        return new zzhir(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }

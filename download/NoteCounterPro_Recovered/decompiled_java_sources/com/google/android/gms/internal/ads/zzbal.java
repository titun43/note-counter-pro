...
public final class zzbal {
    ...
    public final void zzb(Context context, View view) {
        ...
        int i5 = zzm.widthPixels * zzm.heightPixels;
        if (view != null) {
            int min = Math.min(view.getHeight(), zzm.heightPixels) * Math.min(view.getWidth(), zzm.widthPixels);
            if (min + min >= i5 || (min == 0 && zzl(view))) {
                this.zze = this.zzc;
                return;
            }
        }

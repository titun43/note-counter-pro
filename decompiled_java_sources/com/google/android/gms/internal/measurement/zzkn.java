...
public final class zzkn {
    ...
    static {
        ...
        zzf = zzknVar6;
        zzkn zzknVar7 = new zzkn("STRING", 6, String.class, String.class, RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED);
        zzg = zzknVar7;
    ...
    private zzkn(String str, int i5, Class cls, Class cls2, Object obj) {
        this.zzl = cls;
        this.zzm = cls2;
        this.zzn = obj;
    }

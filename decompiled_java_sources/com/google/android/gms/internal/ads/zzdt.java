...
public final class zzdt implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void zza(int i5) {
        ...
        zzdv.zzf(eglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzdv.zzf(EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        ...
        String str = zzfj.zza;
        zzdv.zzf(z4, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", objArr));
        EGLConfig eGLConfig = eGLConfigArr[0];
        EGLContext eglCreateContext = EGL14.eglCreateContext(this.zzd, eGLConfig, EGL14.EGL_NO_CONTEXT, i5 == 0 ? new int[]{12440, 2, 12344} : new int[]{12440, 2, 12992, 1, 12344}, 0);
        zzdv.zzf(eglCreateContext != null, "eglCreateContext failed");
        ...
        if (i5 == 1) {
            ...
            zzdv.zzf(eglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdv.zzf(EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext), "eglMakeCurrent failed");

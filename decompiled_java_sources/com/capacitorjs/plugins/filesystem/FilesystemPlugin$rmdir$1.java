...
@e(c = "com.capacitorjs.plugins.filesystem.FilesystemPlugin$rmdir$1", f = "FilesystemPlugin.kt", l = {174}, m = "invokeSuspend", v = 1)
/* loaded from: classes.dex */
public final class FilesystemPlugin$rmdir$1 extends g implements p {
    ...
    public FilesystemPlugin$rmdir$1(FilesystemPlugin filesystemPlugin, SingleUriWithRecursiveOptions singleUriWithRecursiveOptions, PluginCall pluginCall, c cVar) {
        super(2, cVar);
    ...
    public final c create(Object obj, c cVar) {
        FilesystemPlugin$rmdir$1 filesystemPlugin$rmdir$1 = new FilesystemPlugin$rmdir$1(this.this$0, this.$input, this.$call, cVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i5 == 0) {
            ...
            b bVar = new b(this.$input.getRecursive());
            this.L$0 = null;
            this.label = 1;
    ...
    public final Object invoke(f0 f0Var, c cVar) {
        return ((FilesystemPlugin$rmdir$1) create(f0Var, cVar)).invokeSuspend(h.f3400a);
    }
}

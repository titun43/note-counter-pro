...
public class PluginHandle {
    ...
    private PluginHandle(Class<? extends Plugin> cls, Bridge bridge) {
        ...
        if (capacitorPlugin == null) {
            ...
            if (nativePlugin.name().equals(RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED)) {
            ...
            if (capacitorPlugin.name().equals(RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED)) {
                this.pluginId = cls.getSimpleName();
            } else {

...
public class CapConfig {
    ...
    public static class Builder {
        ...
        public CapConfig create() {
            ...
            return new CapConfig(this, i5);
        }

        public Builder setAllowMixedContent(boolean z4) {
            this.allowMixedContent = z4;
            return this;
        }
        ...
        public Builder setCaptureInput(boolean z4) {
            this.captureInput = z4;
            return this;
        }
        ...
        public Builder setHTML5mode(boolean z4) {
            this.html5mode = z4;
            return this;
        }
        ...
        public Builder setInitialFocus(boolean z4) {
            this.initialFocus = z4;
            return this;
        }

        public Builder setLoggingEnabled(boolean z4) {
        ...
        public Builder setResolveServiceWorkerRequests(boolean z4) {
            this.resolveServiceWorkerRequests = z4;
            return this;
        }
        ...
        public Builder setUseLegacyBridge(boolean z4) {
            this.useLegacyBridge = z4;
            return this;
        }

        public Builder setWebContentsDebuggingEnabled(boolean z4) {
            this.webContentsDebuggingEnabled = Boolean.valueOf(z4);
            return this;
        }

        public Builder setZoomableWebView(boolean z4) {
            this.zoomableWebView = z4;
            return this;
        }
    }

    public /* synthetic */ CapConfig(Builder builder, int i5) {
        this(builder);
    }
    ...
    private void deserializeConfig(Context context) {
        ...
        this.webContentsDebuggingEnabled = JSONUtils.getBoolean(this.configJSON, "android.webContentsDebuggingEnabled", z4);
    ...
    private void loadConfigFromFile(String str) {
        ...
        try {
            ...
            Logger.error("Unable to load capacitor.config.json.", e4);
        } catch (JSONException e5) {
            Logger.error("Unable to parse capacitor.config.json. Make sure it's valid json", e5);
        }
    }
    ...
    public boolean getBoolean(String str, boolean z4) {
        return JSONUtils.getBoolean(this.configJSON, str, z4);
    }
    ...
    public int getInt(String str, int i5) {
        return JSONUtils.getInt(this.configJSON, str, i5);
    }

    public int getMinHuaweiWebViewVersion() {
        int i5 = this.minHuaweiWebViewVersion;
        if (i5 >= 10) {
            return i5;
        }

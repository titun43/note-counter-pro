...
final class zzdp extends zzcr {
    ...
    */
    public static zzdp zzg(int i5, Object[] objArr, zzcq zzcqVar) {
        boolean z4;
        int i6;
        char c5;
        Object obj;
        ...
        zzbe.zzb(i8, objArr2.length >> 1, "index");
        int zzh = zzcv.zzh(i8);
        char c7 = 2;
        if (i8 == 1) {
            ...
            if (zzh <= 128) {
                ...
                while (i11 < i8) {
                    ...
                    zzbw.zzb(obj7, obj8);
                    int zza2 = zzcg.zza(obj7.hashCode());
                    while (true) {
                        int i15 = zza2 & i10;
                        z5 = z8;
                        i7 = i9;
                        ...
                        if (i16 == 255) {
                            ...
                            if (obj7.equals(objArr2[i16])) {
                                ...
                                zzcp zzcpVar = new zzcp(obj7, obj8, obj9);
                                objArr2[i17] = obj8;
                                obj2 = zzcpVar;
                                break;
                            }
                ...
                if (zzh > 32768) {
                    ...
                    while (i18 < i8) {
                        ...
                        zzbw.zzb(obj10, obj11);
                        int zza3 = zzcg.zza(obj10.hashCode());
                        while (true) {
                            int i22 = zza3 & i10;
                            int i23 = iArr[i22];
                            if (i23 == -1) {
                                ...
                                if (obj10.equals(objArr2[i23])) {
                                    ...
                                    zzcp zzcpVar2 = new zzcp(obj10, obj11, obj12);
                                    objArr2[i24] = obj11;
                                    obj2 = zzcpVar2;
                                    break;
                                }
                    ...
                    return new zzdp(obj13, objArr2, i8);
                }
                sArr = new short[zzh];
                ...
                for (int i26 = 0; i26 < i8; i26++) {
                    ...
                    zzbw.zzb(obj15, obj16);
                    int zza4 = zzcg.zza(obj15.hashCode());
                    while (true) {
                        int i29 = zza4 & i10;
                        ...
                        if (c8 == 65535) {
                            ...
                            if (obj15.equals(objArr2[c8])) {
                                ...
                                zzcp zzcpVar4 = new zzcp(obj15, obj16, obj17);
                                objArr2[i30] = obj16;
                                obj2 = zzcpVar4;
                                break;
                            }
        ...
        return new zzdp(obj132, objArr2, i8);
    }

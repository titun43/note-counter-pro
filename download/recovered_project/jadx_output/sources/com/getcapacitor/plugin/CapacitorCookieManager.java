...
public class CapacitorCookieManager extends CookieManager {
    ...
    public String getCookieString(String str) {
        try {
            ...
            Logger.error("CapacitorCookies", "Failed to get cookies at the given URL.", e4);
            return null;
        }
    }
    ...
    public String getSanitizedDomain(String str) {
        ...
        if (str2 == null || str2.isEmpty() || !(str == null || str.isEmpty() || this.serverUrl.contains(str))) {
            ...
            if (str3 == null || str3.isEmpty() || !(str == null || str.isEmpty() || this.localUrl.contains(str))) {
                try {
                    ...
                    Logger.error("CapacitorCookies", "Failed to get scheme from URL.", e4);
                }
            } else {
                str = this.localUrl;
            }
        ...
        try {
            ...
            Logger.error("CapacitorCookies", "Failed to get sanitized URL.", e5);
            throw e5;
        }
    }
    ...
    public void setCookie(String str, String str2) {
        try {
            ...
            Logger.error("CapacitorCookies", "Failed to set cookie.", e4);
        }
    }
